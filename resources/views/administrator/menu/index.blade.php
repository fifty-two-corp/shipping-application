    ...
    <div class="row">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-5">
          <div class="panel-heading">
              ...
              <h4 class="panel-title">Parent Menu</h4>
          </div>
          <div class="panel-body">
            <div class="email-btn-row">
                <a href="javascript:;" id="btn_new" class="btn btn-sm btn-primary" onclick="show_modal_parent_menu()">New Parent Menu</a>
                <a href="javascript:;" id="btn_edit_province" class="btn btn-sm btn-default disabled btn_dynamic_province" onclick="show_modal_edit_parent()">Edit</a>
                <a href="javascript:;" id="btn_delete" class="btn btn-sm btn-default disabled btn_dynamic" onclick="delete_parent_menu()">Delete</a>
...
<script type="text/javascript">
  ...
  get_city_default();
  parentTable = $('#province_table').DataTable({
    processing: false,
    serverSide: true,
    searchHighlight: true,
    ajax: {
      url:'{{ url("menu/get-parent-menu") }}', 
      deferRender: true,
    },
    deferRender: true,
    responsive:true,
