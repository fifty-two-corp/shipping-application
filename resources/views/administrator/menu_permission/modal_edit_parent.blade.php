<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            {!! Form::model($parent_menu, ['method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'form-edit-parent']) !!}
              <div class="row">
             ...
             <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn-save" onclick="save_parent_edit_data()">Save changes</button>
