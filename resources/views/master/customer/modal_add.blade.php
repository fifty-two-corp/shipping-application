<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="modalService">New Customer</h4>
    </div>
    <div class="modal-body">
      {!! Form::open(array('class' => 'form-horizontal', 'id' => 'form-customer-add')) !!}
        <div class="row">
          <div class="alert alert-danger fade in m-b-15" id="customer-allert" hidden>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
              ...
              <div class="col-md-9">
                {!! Form::text('customer_number', null, ['placeholder' => 'Customer Number','class' => 'form-control']) !!}
              </div>
            </div>
          </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <div class="input-group">
                      {!! Form::number('discount', 0, ['placeholder' => 'Discount','class' => 'form-control', 'id' => 'discount']) !!}
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="btn-save" onclick="save_customer_data()">Save changes</button>
      </div>
    </div>
  </div>
</div>
